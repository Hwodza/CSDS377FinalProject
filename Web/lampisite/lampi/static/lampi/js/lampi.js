...
const deviceId = 'b827ebdb1727'; // FILL IN WITH THE DEVICEID OF YOUR LAMPI DEVICE
	...
	obj = {
		...
		onConnect: function (response) {
			...
			obj.client.subscribe(
				'$SYS/broker/connection/' + deviceId + '_broker/state',
				{ qos: 1 }
			);
		},
		...
		client: new Paho.MQTT.Client(hostAddress, Number(hostPort), clientId),
		updateTimer: null,
		...
		init: function () {
			if (deviceId == '') {
				alert(
					"PLEASE FILL IN THE 'deviceId' VARIABLE IN 'lampi.js'," +
